...
class AppShell(Pmw.MegaWidget):
    ...
    def __init__(self, **kw):
        ...
        self.dAboutInfo = {
            ...
            'copyright'     : 'Ghostbusters, Inc. All Rights Reserved',
            'contactname'   : 'Chief Ghostbuster',
            'contactphone'  : '800 555-1212',
            'contactemail'  : 'chief@ghostbusters.com' }
        #
        if 'dAboutInfo' in kw:
            #
            self.dAboutInfo.update( kw[ 'dAboutInfo' ] )
            #
            del kw[ 'dAboutInfo' ]
            #
        #
    ...
    def __createAboutBox(self):
        Pmw.aboutversion(self.dAboutInfo[ 'appversion' ])
        Pmw.aboutcopyright(self.dAboutInfo[ 'copyright' ])
        Pmw.aboutcontact(
          'For more information, contact:\n %s\n Phone: %s\n Email: %s' %\
                      (self.dAboutInfo[ 'contactname' ],
                       self.dAboutInfo[ 'contactphone' ],
                       self.dAboutInfo[ 'contactemail' ]))
        self.about = Pmw.AboutDialog(self._hull,
                            applicationname=self.dAboutInfo[ 'appname' ])
        self.about.withdraw()
        return None
    ...
    def __createInterface(self):
        ...
        self.createMenuBar()
        self.createMenuBarHelp()    # put it on right
