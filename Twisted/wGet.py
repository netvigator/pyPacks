...
# -*- coding: utf-8 -*-
#
# Twisted functions Twisted Matrix get
#
...
'''
classes implementing asynchronous non-blocking searches
...
from Object.Get         import getPropertyValue
from Object.Patterns    import ObserverClass
...
class getPagesClass( ObserverClass ):
    ...
    def __init__( self,
            ...
            uObservers      = None ):
        #
        from Collect.Extend import FifoPopper
        #
    ...
    def doNext( self, iSlot = None, iSlot2Avoid = None, bUpdate = True ):
       ...
       #from Utils.Both2n3  import getNext
        ...
        if iSlot is not None and not self.bNoMorePages:
            #
            while sURL is None and self.lURLsFiFo:
                #
    ...
    def getPlainText( self, sFileName ):
        ...
        from Web.Zip  import getPlainIfZipped
        #
        return getPlainIfZipped( getContent( sFileName ) )
    ...
    def getDownLoadSlot( self, iSlot2Avoid = None ):
        #
        from Iter.AllVers   import tFilter
        from Collect.Info   import getAllIndexes
        #
    ...
    def getSayDuration( self, sURL ):
        #
        from Time.Output import getSayDurationAsDaysHrsMinsSecs
        #
        if sURL in self.dBegEndTimes:
            #
...
def _getLinksSamples( oGetPages, sHTML, sURL, uThis, sTempFile, iSlot, oSuccess ):
    ...
    """
    #
    from Collect.Cards  import getRandoms
